        ...
        <div className="resources-frame-div">
          <div className="resources-column">
            ...
            <div className="resources-frame-parent1">
              <img className="resources-frame-child" alt="New U.S. Citizens" src="/img/usct.png" />
              <div className="resources-frame-parent2">
                ...
                <div className="resources-button">
                  <img className="resources-icon" alt="arrow icon" src="/img/SubtleIconButton.png" />
                </div>
              </div>
            </div>
            ...
            {/* Card 2 */}
            <div className="resources-frame-parent1">
              <img className="resources-frame-child" alt="Learn About Citizenship" src="/img/usct.png" />
              <div className="resources-frame-parent2">
                <div className="resources-info-title-parent">
            ...
            {/* Card 3 */}
            <div className="resources-frame-parent1">
              <img className="resources-frame-child" alt="Apply for Citizenship" src="/img/usct.png" />
              <div className="resources-frame-parent2">
                <div className="resources-info-title-parent">
          ...
          <div className="resources-column">
            {/* Card 4 */}
            <div className="resources-frame-parent1">
              <img className="resources-frame-child" alt="Naturalization Test and Study Resources" src="/img/usct.png" />
              <div className="resources-frame-parent2">
                <div className="resources-info-title-parent">
            ...
            {/* Card 5 */}
            <div className="resources-frame-parent1">
              <img className="resources-frame-child" alt="Learn About the Citizenship Grant Program" src="/img/usct.png" />
              <div className="resources-frame-parent2">
                <div className="resources-info-title-parent">
            ...
            {/* Card 6 */}
            <div className="resources-frame-parent1">
              <img className="resources-frame-child" alt="Resources for Educational Programs" src="/img/usct.png" />
              <div className="resources-frame-parent2">
                <div className="resources-info-title-parent">
