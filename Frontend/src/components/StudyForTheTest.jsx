            ...
            <div className="mb-5">
                ...
                <div className="row">
                    <div className="col-sm-6 mb-3 mb-sm-0">
                        <div className="card border-0 shadow-sm h-100">
                            <div className="card-body">
                                <Link to="/category/Questions for the Naturalization Test" className="card-title h5 text-decoration-none text-primary">
                                    Study 100 questions
                                </Link>
                    ...
                    <div className="col-sm-6">
                        <div className="card border-0 shadow-sm h-100">
                            <div className="card-body">
                                <Link to="/category/Random Questions" className="card-title h5 text-decoration-none text-primary">
                        ...
                        <div className="card border-0 shadow-sm h-100 theme-card">
                            <div className="row no-gutters">
                                ...
                                <div className="col-md-8">
                                    <div className="card-body">
                                        <Link to="/category/Principles of American Democracy" className="card-title h6 text-decoration-none text-primary">
                                            American democracy
                                        </Link>
                    ...
                    <div className="col-md-4 mb-3">
                        <div className="card border-0 shadow-sm h-100 theme-card">
                            <div className="row no-gutters">
                                ...
                                <div className="col-md-8">
                                    <div className="card-body">
                                        <Link to="/category/System of Government" className="card-title h6 text-decoration-none text-primary">
                                            American Government
                                        </Link>
                    ...
                    <div className="col-md-4 mb-3">
                        <div className="card border-0 shadow-sm h-100 theme-card">
                            <div className="row no-gutters">
                                ...
                                <div className="col-md-8">
                                    <div className="card-body">
                                        <Link to="/category/Rights and Responsibilities" className="card-title h6 text-decoration-none text-primary">
                                            Rights
                                        </Link>
                ...
                <div className="col-md-4 mb-3">
                    <div className="card border-0 shadow-sm h-100 theme-card">
                        <div className="row no-gutters">
                            ...
                            <div className="col-md-8">
                                <div className="card-body">
                                    <Link to="/category/Colonial Period and Independence" className="card-title h6 text-decoration-none text-primary">
                                        The Colonial Period
                                    </Link>
                ...
                <div className="col-md-4 mb-3">
                    <div className="card border-0 shadow-sm h-100 theme-card">
                        <div className="row no-gutters">
                            ...
                            <div className="col-md-8">
                                <div className="card-body">
                                    <Link to="/category/Recent American History" className="card-title h6 text-decoration-none text-primary">
                                        1800's
                                    </Link>
                ...
                <div className="col-md-4 mb-3">
                    <div className="card border-0 shadow-sm h-100 theme-card">
                        <div className="row no-gutters">
                            ...
                            <div className="col-md-8">
                                <div className="card-body">
                                    <Link to="/category/Geography" className="card-title h6 text-decoration-none text-primary">
                                        Geography
                                    </Link>
                ...
                <div className="col-md-4 mb-3">
                    <div className="card border-0 shadow-sm h-100 theme-card">
                        <div className="row no-gutters">
                            ...
                            <div className="col-md-8">
                                <div className="card-body">
                                    <Link to="/category/Symbols" className="card-title h6 text-decoration-none text-primary">
                                        Symbols
                                    </Link>
                ...
                <div className="col-md-4 mb-3">
                    <div className="card border-0 shadow-sm h-100 theme-card">
                        <div className="row no-gutters">
                            ...
                            <div className="col-md-8">
                                <div className="card-body">
                                    <Link to="/category/Holidays" className="card-title h6 text-decoration-none text-primary">
                                        Holidays
                                    </Link>
